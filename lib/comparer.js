 ...
 *
 * @param {Array} files - An array of two files to compare.
 ...
 *
 * @param {Object} comparison - The comparison data to use.
 */
Comparer.prototype._compare = function (comparison) {
  var compare = require(path.resolve(__dirname, '../comparisons', comparison.name));
